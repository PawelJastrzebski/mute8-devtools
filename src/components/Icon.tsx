...
function getSvgIcon(name: IconsNames, size: number = 24) {
    ...
    if (name == 'expand-more') {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} viewBox="0 -960 960 960" ><path fill="#fff" d="M480-345 240-585l56-56 184 184 184-184 56 56-240 240Z"/></svg>
        )
    }
    if (name == 'up') {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} viewBox="0 -960 960 960"><path fill="#fff" d="m296-345-56-56 240-240 240 240-56 56-184-184-184 184Z"/></svg>
        )
    }
    if (name == 'down') {
        return (
